              ...
              <div className="lg:w-5/12 max-w-[635px]">
                <div className="space-y-[46px]">
                  <h1 className="text-5xl 3xl:text-[65px] font-black inline-block relative">
                    ...
                    <div className="absolute -bottom-[10px] left-0 w-full bg-pink-2 h-[23px]">
                      &nbsp;
                    </div>
                  </h1>
                  <div className="space-y-[35px]">
                    <p className="text-justify">
                      Esta herramienta es un explorador de datos sobre
                      contratación pública en Ecuador. Mensualmente, verifica
                      los procedimientos registrados en la Plataforma de
                      Contrataciones Abiertas Ecuador-OCDS y marca
                      comportamientos que podrían clasificarse - o no - como{' '}
                      <Link href="/metodologia">
                        <a className="underline">banderas rojas</a>
                      </Link>
                      .
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-3xl overflow-hidden">
                    <iframe
                      ...
                      src="https://www.youtube.com/embed/74oVxLzh9L8"
                    ></iframe>
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto w-10/12 max-w-screen-3xl">
          <div className="text-center text-white-dark space-y-6 3xl:space-y-12">
            ...
            <div className="font-roboto max-w-xl mx-auto">
              <p>
                Cada procedimiento marcado con una bandera roja muestra un
                posible comportamiento sospechoso que requiere verificación
                adicional.{' '}
                <a
                  className="text-orange italic underline"
                  href="https://docs.google.com/spreadsheets/d/17R_5TrYdQRKtcFyiMlH7sch4nBU9RS1isJWNx2ae7yg/edit?usp=sharing"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="flex gap-2 justify-center">
              <select
                className="p-3 text-grey rounded-[15px] w-[168px]"
                name="years"
              ...
              {year && (
                <a
                  className="gap-x-4 items-center bg-red py-2 px-6 rounded-[15px] text-lg 3xl:text-xl flex"
                  download
                  target="_blank"
                  rel="noreferrer"
                  href={generateLink(year)}
                >
                  <ArrowDownTrayIcon className="h-5 w-5" />
                  <p>Descargar</p>
                </a>
...
export const getServerSideProps = async () => {
  ...
  // DINAMYC YEARS
  const years = data.hdtables_slugs
    .reduce((prev, curr) => {
