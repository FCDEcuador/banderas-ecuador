              ...
              <div className="space-y-[30px]">
                <h1 className="font-black text-5xl 3xl:text-6xl">
                  ...
                  <span className="relative">
                    <span className="relative z-10">Contratación Pública</span>
                    <div className="absolute bg-pink h-4 w-full left-0 bottom-1">
                      &nbsp;
                    </div>
                  </span>
                </h1>
                <p className="text-justify">
                  ...
                  <a
                    href="https://www.ciudadaniaydesarrollo.org/"
                    target="_blank"
                    className="italic text-gemstone-green underline"
                    rel="noreferrer"
                  >
                    Fundación Ciudadanía y Desarrollo
                  </a>{' '}
                  que, a través del análisis y difusión de datos de la
                  contratación pública, busca promover la contratación abierta
                  en Ecuador.
                </p>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-y-8">
            <div className="lg:w-5/12 max-w-[507px]">
              <div className="space-y-8 text-white-dark">
                ...
                <p className="text-justify">
                  Entérate cómo se están utilizando los recursos públicos a
                  través de la contratación pública en nuestros informes e
                  investigaciones.
                </p>
                <Link href="/informes">
        ...
        <div className="mx-auto w-10/12 lg:w-9/12 max-w-screen-2xl">
          <div className="flex flex-col lg:flex-row lg:justify-between gap-y-8">
            ...
            <div className="lg:w-6/12 max-w-[655px]">
              <p className="text-lg lg:text-xl text-white-dark text-justify">
                Conoce a las instituciones públicas que mejor desempeño
                presentaron según las categorías de transparencia, temporalidad,
                trazabilidad, competitividad y confiabilidad. La clasificación
                incluye a las instituciones que efectuaron al menos 100
                contratos durante el año en curso o durante el año anterior. La
                información correspondiente al año en curso se actualiza a mes
                vencido, así podrás conocer cómo las instituciones públicas
                están contratando.
                <a
                  className="block mt-[35px] underline text-red"
                  href="https://docs.google.com/document/d/1Jo0w6H6uR5SyzNB9wH8s6dZReER85OwM/edit"
                  target="_blank"
                  rel="noreferrer"
                >
                  Mira aquí más sobre nuestra metodología.
                </a>
              </p>
            </div>
          </div>
          <div className="mt-10 relative z-10">
            <div className="relative">
              ...
              <div
                className={classNames(
                  'lg:hidden absolute top-1/2 -translate-y-1/2 duration-300',
                  { 'left-0': hasLimit, '-left-full': !hasLimit }
                )}
              >
              ...
              <div
                className={classNames(
                  'lg:hidden absolute top-1/2 -translate-y-1/2 duration-300',
                  { 'right-0': !hasLimit, '-right-full': hasLimit }
                )}
              >
            ...
            <div className="mt-4">
              <p className="text-white text-sm">
                ...
                {new Intl.DateTimeFormat('es-CO', { dateStyle: 'long' }).format(
                  addDays(new Date(lastUpdated), 1)
                )}
              </p>
            </div>
                  ...
                  <div className="pb-[27px]">
                    ...
                    <div className="text-center space-y-4 px-2">
                      <p className="text-gemstone-green text-3xl 3xl:text-[45px] font-black">
                        {new Intl.NumberFormat('es-CO', {
                          maximumFractionDigits: 0
                        }).format(stats.countract_amount)}
                      </p>
                      <p className="text-sm 3xl:text-base mt-1">
                        valor nominal adjudicado en USD
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="shadow rounded-[55px]">
                  <div className="pb-[27px] pt-[43px] px-10">
                    <div className="text-center space-y-4 px-2">
                      ...
                      <p className="text-sm 3xl:text-base mt-1">
                        procedimientos de contratación con un solo oferente
                      </p>
                    </div>
                  </div>
                </div>
                <div className="shadow rounded-[55px]">
                  <div className="pb-[27px] pt-[43px] px-10">
                    <div className="text-center space-y-4 px-2">
                      ...
                      <p className="text-sm 3xl:text-base mt-1">
                        procedimientos de contratación tuvieron un período corto
                ...
                <div className="shadow rounded-[55px]">
                  <div className="pb-[27px] pt-[43px] px-10">
                    <div className="text-center space-y-4 px-2">
                      ...
                      <p className="text-sm 3xl:text-base mt-1">
                        proveedores han obtenido un número desproporcionado de
            ...
            <div className="lg:w-6/12 max-w-[756px]">
              <div className="space-y-[50px]">
                <div className="text-white space-y-[35px]">
                  ...
                  <p className="text-justify">
                    Las “banderas rojas” en la contratación pública son
                    indicadores de comportamientos sospechosos que pueden
                    ocurrir en todas las etapas de un procedimiento de
                    contratación, desde la publicación de la convocatoria
                    pasando por la adjudicación, hasta la ejecución del
                    contrato.
                  </p>
                  <p className="text-justify">
                    Herramientas como éstas permiten detectar y prevenir la
                    corrupción. Asimismo, permite verificar la integridad del
                    sistema de contratación pública mediante la identificación
                    de adquisiciones riesgosas.
                  </p>
                  <p className="text-justify">
                    La metodología para identificar banderas rojas en
                    procedimientos de contratación pública en Ecuador tomó en
                    cuenta cinco categorías:
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-8 md:gap-[55px]">
                  {redFlagsImages.map(({ title, urlImage }, index) => (
                    <RedFlagCard
                      key={`red-flag-${index + 1}`}
                      title={title}
                      urlImage={urlImage}
                    />
                  ))}
      ...
      <div className="py-12 lg:py-16 xl:py-20">
        <div className="mx-auto w-10/12 max-w-screen-2xl">
          <div className="text-center max-w-[632px] mx-auto">
            ...
            <p className="mt-6">
              Esta herramienta de visualización de datos permite observar cómo
              se comportan las banderas rojas identificadas en los
              procedimientos de contratación pública en Ecuador.
            </p>
          ...
          <div className="mt-16">
            <iframe
              ...
              src="https://services.datasketch.co/banderas-app/"
              width="100%"
            ></iframe>
          </div>
        </div>
